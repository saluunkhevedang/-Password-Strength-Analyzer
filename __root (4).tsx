  ...
  head: () => ({
    meta: [
      ...
      { title: "Password Strength Analyzer" },
      {
        name: "description",
        content:
          "Analyze password strength in real time — 8 security checks, live scoring, and suggestions. 100% local in your browser.",
      },
      { name: "author", content: "Password Strength Analyzer" },
